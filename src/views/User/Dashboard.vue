...
import iphone15 from "@/assets/image/iphone15.png";
         ...
         <div class="d-flex flex-wrap">
            ...
            <div class="card card-product" style="" v-for="(product, index) in listProduct" :key="index">
               <img v-if="product.image != null" :src="urlImage + product.image" class="card-img-top"
                  :alt="product.name">
               <img v-else :src="iphone" class="card-img-top" :alt="product.name">
               <img v-else :src="iphone15" class="card-img-top" :alt="product.name">
               <div class="card-body">
